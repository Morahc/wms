...
export default async function ShipmentDetails(props: PageProps<"/shipments/[shipmentId]">) {
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <Link href={"/shipments"} className={cn(buttonVariants({ variant: "link" }), "text-sm")}>
